...
from vans_gym.models.DQN import DQN
...
if __name__ == "__main__":
    ...
    model = DQN(env, name=args.names, policy=args.policy_agent, ep=args.ep, use_tqdm=not args.use_tqdm, plotter=args.plotter, learning_rate=args.learning_rate,tau=args.tau, priority_scale=args.priority_scale, use_per=True, fits_per_ep=args.fitsep) #tqdm 0 not using, 1 using
