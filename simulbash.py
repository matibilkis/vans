...
############# CONDENSED MATTER ############
            ##### XXZ #######
problem_config = dict_to_json({"problem" : "XXZ", "g":1.0, "J": args.J})
q=14
            ##### tfim #######
...
############### LANL LAST RUN #####
st = "python3 main.py --path_results \"{}\" --qlr 0.01 --acceptance_percentage 0.001 --n_qubits {} --reps 1000 --qepochs 2000 --problem_config {} --show_tensorboarddata 0 --optimizer adam --training_patience 200 --rate_iids_per_step 1.0 --wait_to_get_back 25".format(path,q,problem_config)
os.system(st)
