...
path = "../data-vans/"
st = "python3 main.py --path_results \"{}\" --qlr 0.01 --acceptance_percentage 0.001 --n_qubits {} --reps 2000 --qepochs 2000 --problem_config {} --show_tensorboarddata 0 --optimizer sgd --training_patience 200 --rate_iids_per_step 1.0 --specific_name __sgd__ --wait_to_get_back 2".format(path,q,problem_config)
os.system(st)
