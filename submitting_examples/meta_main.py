...
for J in [1]:
    instruction = "python3 main.py --path_results "+"\"../data-vans/\""+" --qlr 0.01 --acceptance_percentage 0.01 --n_qubits "+str(QUBITS)+" --reps "+str(GENETIC_RUNS)+" --qepochs "+str(QEPOCHS)+ " --problem_config "+problem_config#+" --noise_config "+noise_config + "
