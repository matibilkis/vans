...
st = "python3 main.py --path_results \"../data-vans/\" --qlr 0.01 --acceptange_percentage 0.05 --n_qubits {} --reps 1000 --qepochs 1000 --problem_config {} --optimizer sgd".format(QUBITS,problem_config)
