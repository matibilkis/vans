...
for bond in [1.5]*4:
    ...
    instruction = "python3 main.py --path_results \"{}\" --qlr 0.001 --acceptance_percentage 0.0005 --n_qubits {} --reps 100 --qepochs 10000 --problem_config {} --show_tensorboarddata 0 --optimizer adam --training_patience 1000 --rate_iids_per_step 1. --wait_to_get_back 20".format(path,q,problem_config)
