...
for bond in [0.5, 1.0, 1.5]:
    ...
    instruction = "python3 main.py --path_results \"{}\" --qlr 0.01 --acceptance_percentage 0.01 --n_qubits {} --reps 200 --qepochs 2000 --problem_config {} --show_tensorboarddata 0 --optimizer adam --training_patience 200 --rate_iids_per_step 1.0 --wait_to_get_back 10".format(path,q,problem_config)
